...
class HTTPException(Exception):
    """Замена FastAPI HTTPException для использования без FastAPI app."""
...
CATEGORY_HINTS: Dict[str, List[str]] = {
    "ЖКХ": ["жкх", "мусор", "тко", "контейнер", "вывоз", "вода", "отопление", "канализация", "свет", "лифт", "управляющая компания", "тсж", "коммунал", "подъезд", "крыша", "труба", "водоснабж", "теплосеть", "электросеть"],
    "Дороги и транспорт": ["дорога", "асфальт", "яма", "пробка", "автобус", "транспорт", "остановка", "светофор", "мост", "переезд", "тротуар", "пешеход", "парковка", "дтп", "гибдд", "маршрут", "трамвай", "метро", "такси", "гололёд"],
    "Здравоохранение": ["больница", "поликлиника", "врач", "терапевт", "скорая", "лекарство", "медицина", "запись", "аптека", "хирург", "стоматолог", "диагноз", "операция", "госпиталь", "фельдшер", "вакцин", "эпидем", "ковид"],
    "Образование": ["школа", "садик", "учитель", "класс", "ученик", "университет", "колледж", "урок", "егэ", "огэ", "директор школы", "детский сад", "кружок", "секция", "образовательн", "педагог", "лицей", "гимназия"],
    "Экология и ЧС": ["экология", "свалка", "загрязнение", "река", "дым", "пожар", "чс", "затопление", "потоп", "выброс", "радиация", "воздух", "мчс", "наводнение", "засуха", "ураган", "смог", "отходы", "очистные", "канцероген"],
    "Экономика и промышленность": ["завод", "предприятие", "бизнес", "зарплата", "инвестиции", "промышленность", "рынок", "безработица", "увольнение", "сокращение", "банкротство", "торговля", "цена", "инфляция", "тариф", "кредит", "долг"],
    "Безопасность и правопорядок": ["полиция", "мвд", "кража", "грабёж", "мошенничество", "наркотик", "убийство", "нападение", "хулиган", "вандал", "терроризм", "экстремизм", "розыск", "суд", "приговор", "задержан", "арест", "преступлен", "рецидив", "дроппер"],
    "Социальная защита": ["пенсия", "пособие", "льгота", "инвалид", "ветеран", "сирота", "многодетн", "малоимущ", "соцзащита", "материнский капитал", "опека", "алименты", "бездомн", "приют", "реабилитац", "волонтёр"],
    "Культура и спорт": ["музей", "театр", "библиотека", "стадион", "спортзал", "фестиваль", "концерт", "выставка", "памятник", "парк", "сквер", "площадка", "секция", "чемпионат", "олимпиада", "кинотеатр", "филармония"],
    "Цифровизация и связь": ["интернет", "связь", "сеть", "мобильн", "провайдер", "портал", "госуслуги", "сайт", "приложение", "цифров", "камера", "видеонаблюдение", "wi-fi", "вышка", "оптоволокно", "мфц"],
    "Сельское хозяйство": ["урожай", "посев", "ферма", "скот", "молоко", "зерно", "пшеница", "агро", "трактор", "удобрение", "засуха", "полив", "сельхоз", "корм", "ветеринар", "земля сельхоз"],
    "Строительство и земля": ["стройка", "новостройка", "дольщик", "застройщик", "разрешение на строительство", "участок", "кадастр", "межеван", "снос", "аварийн", "расселение", "ремонт дома", "капремонт", "фасад", "фундамент", "жилищн"],
    "Религия и духовная жизнь": ["церковь", "храм", "мечеть", "синагога", "священник", "имам", "богослужение", "литургия", "приход", "епархия", "муфтият", "религиозн", "конфесси", "секта", "миссионер", "паломник", "духовн", "вера", "молитва", "пасха", "рамадан"],
}
...
LOCATION_ALIASES = [
    ...
    # Москва и МО
    ("москва", {"region": "Москва", "city": "Москва"}),
    ("московская область", {"region": "Московская область"}),
    ("подмосковье", {"region": "Московская область"}),
    # Санкт-Петербург и ЛО
    ("санкт-петербург", {"region": "Санкт-Петербург", "city": "Санкт-Петербург"}),
    ("петербург", {"region": "Санкт-Петербург", "city": "Санкт-Петербург"}),
    ("ленинградская область", {"region": "Ленинградская область"}),
    # Краснодарский край
    ("краснодарский край", {"region": "Краснодарский край"}),
    ("краснодар", {"region": "Краснодарский край", "city": "Краснодар"}),
    ("сочи", {"region": "Краснодарский край", "city": "Сочи"}),
    ("новороссийск", {"region": "Краснодарский край", "city": "Новороссийск"}),
    ("анапа", {"region": "Краснодарский край", "city": "Анапа"}),
    # Крупные города
    ("новосибирск", {"region": "Новосибирская область", "city": "Новосибирск"}),
    ("екатеринбург", {"region": "Свердловская область", "city": "Екатеринбург"}),
    ("казань", {"region": "Республика Татарстан", "city": "Казань"}),
    ("нижний новгород", {"region": "Нижегородская область", "city": "Нижний Новгород"}),
    ("челябинск", {"region": "Челябинская область", "city": "Челябинск"}),
    ("самара", {"region": "Самарская область", "city": "Самара"}),
    ("омск", {"region": "Омская область", "city": "Омск"}),
    ("уфа", {"region": "Республика Башкортостан", "city": "Уфа"}),
    ("красноярск", {"region": "Красноярский край", "city": "Красноярск"}),
    ("воронеж", {"region": "Воронежская область", "city": "Воронеж"}),
    ("пермь", {"region": "Пермский край", "city": "Пермь"}),
    ("волгоград", {"region": "Волгоградская область", "city": "Волгоград"}),
    ("саратов", {"region": "Саратовская область", "city": "Саратов"}),
    ("тюмень", {"region": "Тюменская область", "city": "Тюмень"}),
    ("тольятти", {"region": "Самарская область", "city": "Тольятти"}),
    ("ижевск", {"region": "Удмуртская Республика", "city": "Ижевск"}),
    ("барнаул", {"region": "Алтайский край", "city": "Барнаул"}),
    ("ульяновск", {"region": "Ульяновская область", "city": "Ульяновск"}),
    ("иркутск", {"region": "Иркутская область", "city": "Иркутск"}),
    ("хабаровск", {"region": "Хабаровский край", "city": "Хабаровск"}),
    ("владивосток", {"region": "Приморский край", "city": "Владивосток"}),
    ("ярославль", {"region": "Ярославская область", "city": "Ярославль"}),
    ("махачкала", {"region": "Республика Дагестан", "city": "Махачкала"}),
    ("томск", {"region": "Томская область", "city": "Томск"}),
    ("оренбург", {"region": "Оренбургская область", "city": "Оренбург"}),
    ("кемерово", {"region": "Кемеровская область", "city": "Кемерово"}),
    ("астрахань", {"region": "Астраханская область", "city": "Астрахань"}),
    ("рязань", {"region": "Рязанская область", "city": "Рязань"}),
    ("пенза", {"region": "Пензенская область", "city": "Пенза"}),
    ("тула", {"region": "Тульская область", "city": "Тула"}),
    ("калининград", {"region": "Калининградская область", "city": "Калининград"}),
    ("курск", {"region": "Курская область", "city": "Курск"}),
    ("ставрополь", {"region": "Ставропольский край", "city": "Ставрополь"}),
    ("белгород", {"region": "Белгородская область", "city": "Белгород"}),
    ("сургут", {"region": "ХМАО", "city": "Сургут"}),
    ("грозный", {"region": "Чеченская Республика", "city": "Грозный"}),
    # Регионы
    ("россия", {"region": "Россия"}),
    ("российская федерация", {"region": "Россия"}),
]
...
async def close_service():
    """Закрыть сервис при завершении приложения."""
    global _service
